                               ...
                               <div class="row">
                                <div class="col-md-12">                                
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control required" value="<?php echo set_value('meta_title') ?>" id="meta_title" name="meta_title" required>
                                    </div>
                               ...
                               <div class="row">  
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea cols="20" rows="5" class="form-control" id="meta_keyword" name="meta_keyword" required><?php echo set_value('meta_keyword') ?></textarea>
                                    </div>
                                </div>
                               </div> 
                               <div class="row">  
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea cols="20" rows="5" class="form-control" id="meta_description" name="meta_description" required><?php echo set_value('meta_description') ?></textarea>
                                    </div>
                                </div>
                               </div> 
